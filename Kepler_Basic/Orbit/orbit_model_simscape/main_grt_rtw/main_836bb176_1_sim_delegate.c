...
void main_836bb176_1_resetSimStateVector(const void *mech, double *state)
{
  double xx[1];
  (void) mech;
  xx[0] = 0.0;
...
void main_836bb176_1_perturbSimJointPrimitiveState(const void *mech, size_t
...
void main_836bb176_1_perturbFlexibleBodyState(const void *mech, size_t stageIdx,
...
void main_836bb176_1_constructStateVector(const void *mech, const double
...
void main_836bb176_1_extractSolverStateVector(const void *mech, const double
...
boolean_T main_836bb176_1_isPositionViolation(const void *mech, const
...
boolean_T main_836bb176_1_isVelocityViolation(const void *mech, const
  RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags, const double
  *state, const int *modeVector)
{
  const double *rtdvd = rtdv->mDoubles.mValues;
...
PmfMessageId main_836bb176_1_projectStateSim(const void *mech, const
...
void main_836bb176_1_computeConstraintError(const void *mech, const
...
boolean_T main_836bb176_1_hasJointDisToNormModeChange(const void *mech, const
...
PmfMessageId main_836bb176_1_performJointDisToNormModeChange(const void *mech,
...
void main_836bb176_1_onModeChangedCutJoints(const void *mech, const int
