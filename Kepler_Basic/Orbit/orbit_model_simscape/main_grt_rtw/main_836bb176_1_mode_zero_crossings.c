...
const NeZCData *main_836bb176_1_ZCData = NULL;
PmfMessageId main_836bb176_1_computeAsmModeVector(const double *input, const
...
PmfMessageId main_836bb176_1_computeSimModeVector(const double *input, const
  double *inputDot, const double *inputDdot, int *modeVector, double
  *errorResult, NeuDiagnosticManager *neDiagMgr)
{
  (void) input;
...
PmfMessageId main_836bb176_1_computeZeroCrossings(const
