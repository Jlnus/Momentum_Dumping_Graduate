...
AXIS_BODY_X = out.BODY_vecX;
AXIS_BODY_Y = out.BODY_vecY;
AXIS_BODY_Z = out.BODY_vecZ;
...
LVLH_X_hlr = quiver3(pos(1,1),pos(1,2),pos(1,3),AXIS_LVLH_X(1,1),AXIS_LVLH_X(1,2),AXIS_LVLH_X(1,3),'k','LineWidth',2); % LVLH X axis
LVLH_Y_hlr = quiver3(pos(1,1),pos(1,2),pos(1,3),AXIS_LVLH_Y(1,1),AXIS_LVLH_Y(1,2),AXIS_LVLH_Y(1,3),'k','LineWidth',2); % LVLH Y axis
LVLH_Z_hlr = quiver3(pos(1,1),pos(1,2),pos(1,3),AXIS_LVLH_Z(1,1),AXIS_LVLH_Z(1,2),AXIS_LVLH_Z(1,3),'k','LineWidth',2); % LVLH Z axis
BODY_X_hlr = quiver3(pos(1,1),pos(1,2),pos(1,3),AXIS_BODY_X(1,1),AXIS_BODY_X(1,2),AXIS_BODY_X(1,3),'r','LineWidth',2); % LVLH X axis
BODY_Y_hlr = quiver3(pos(1,1),pos(1,2),pos(1,3),AXIS_BODY_Y(1,1),AXIS_BODY_Y(1,2),AXIS_BODY_Y(1,3),'g','LineWidth',2); % LVLH Y axis
BODY_Z_hlr = quiver3(pos(1,1),pos(1,2),pos(1,3),AXIS_BODY_Z(1,1),AXIS_BODY_Z(1,2),AXIS_BODY_Z(1,3),'b','LineWidth',2); % LVLH Z axis
...
%     set(ECEF_Z_hlr, 'UData', AXIS_ECEF_Z(i,1), 'VData', AXIS_ECEF_Z(i,2), 'WData', AXIS_ECEF_Z(i,3));
    ...
    set(BODY_X_hlr, 'XData', pos(i,1), 'YData', pos(i,2), 'ZData', pos(i,3), ...
                    'UData', AXIS_BODY_X(i,1), 'VData', AXIS_BODY_X(i,2), 'WData', AXIS_BODY_X(i,3));
    set(BODY_Y_hlr, 'XData', pos(i,1), 'YData', pos(i,2), 'ZData', pos(i,3), ...
                    'UData', AXIS_BODY_Y(i,1), 'VData', AXIS_BODY_Y(i,2), 'WData', AXIS_BODY_Y(i,3));
    set(BODY_Z_hlr, 'XData', pos(i,1), 'YData', pos(i,2), 'ZData', pos(i,3), ...
                    'UData', AXIS_BODY_Z(i,1), 'VData', AXIS_BODY_Z(i,2), 'WData', AXIS_BODY_Z(i,3));
